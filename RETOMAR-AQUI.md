...
- **`docs/CONTENIDO-RRSS-B2G.md`** (27-ago) — a diferencia del kit de arriba, que es para que la municipalidad se lo publique a sus vecinos, este es para la cuenta de TuMuniAquí como producto, dirigido a otros alcaldes. Explica cómo grabar la demo sin salir en cámara (captura de pantalla, no cara) y da cuatro guiones listos: el gancho de las 3 preguntas, la demo del WhatsApp en vivo, el caso real (sin nombrar la municipalidad cliente), y el testimonio del Alcalde. Incluye el carrusel ya armado en `docs/carrusel-b2g/` (6 imágenes, paleta real de la marca, sin ofrecer piloto gratuito, con el correo de contacto y la mención a LOG-In Soluciones Integrales SpA).
