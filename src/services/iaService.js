...
// cada función devuelve null y el vecino sigue reportando exactamente como
...
// El vecino está mirando la pantalla. Pasado este tiempo se sigue sin
// sugerencia — es preferible a dejarlo esperando por algo que es opcional.
const TIMEOUT_MS = 12000

// El chequeo de duplicados es más impaciente que el resto: ahí el vecino ya
...
// (cola de reportes, §10) y esto es justamente lo prescindible.
function haySenal() {
...
// no van a hacer nada (ej. el botón de resumen en el panel del Alcalde).
