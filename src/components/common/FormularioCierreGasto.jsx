...
// Cierre de gasto real al resolver una incidencia — usado tanto por Terreno
// (DetalleTarea.jsx) como por el Jefe de Departamento cuando resuelve directo
// (PanelGestionDepartamento.jsx). Antes cada uno tenía su propio "costo final"
...
export default function FormularioCierreGasto({ incidencia, guardando, error, onResolver }) {
  ...
  const presupuesto = incidencia.presupuesto_estimado
