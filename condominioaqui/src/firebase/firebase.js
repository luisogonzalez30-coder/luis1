...
// App secundaria, solo para que un Administrador cree cuentas de otros usuarios
// (usuariosService.js). createUserWithEmailAndPassword inicia sesión
// automáticamente como el usuario recién creado; sin una app separada, eso
// desloguearía al Administrador de su propia sesión cada vez que crea a alguien.
...
// por el código y typos como 'solicitud' vs 'solicitudes'.
// Los nombres NO se comparten con ningún otro producto. Si algún día este
// proyecto termina apuntando al mismo proyecto de Firebase que otra app, estas
// colecciones siguen siendo suyas y no hay forma de que un bug de allá escriba
// acá. Lo ideal igual es un proyecto de Firebase propio: ver LEEME.md.
export const COLECCIONES = {
  SOLICITUDES: 'solicitudes',
  CONDOMINIOS: 'condominios',
  USUARIOS: 'usuarios_condominio',
  TICKETS: 'tickets_condominio',
  PERSONAL: 'personal',
  DISPOSITIVOS: 'dispositivos_condominio', // marca de tiempo por dispositivo, para el límite anti-spam
}
