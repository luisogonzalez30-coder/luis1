...
// monta, la pantalla de carga de index.html se queda puesta, y el residente ve el
...
function mostrarErrorDeArranque(error) {
  ...
  // Si el condominio está caído, el residente igual necesita resolver su problema.
