...
// Barra inferior del lado residente. Tres destinos y nada más: en una app que
// un residente abre dos veces al año, cada opción extra es una decisión que
...
export default function BarraNavegacion({ condominioSlug }) {
  const { pathname } = useLocation()

  const base = `/${condominioSlug}`
  const destinos = [
    {
      to: `${base}/estado`,
      icono: Search,
