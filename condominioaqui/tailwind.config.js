...
export default {
  ...
  theme: {
    extend: {
      ...
      colors: {
        // Colores por condominio (multi-tenant): se leen de variables CSS aplicadas
        ...
        // Tokens que NO cambian por condominio (definidos en index.css).
        ...
        // identidad (una serie, un area) — solo para bueno/malo.
        estado: {
