...
// Quita tildes y pasa a minúscula: el residente escribe "arbol" o "semaforo" sin
...
// ajena a la app y obligaba a leer las 58 categorías de corrido. Acá el residente
...
export default function SelectorCategoria({ categoria, onCambiar }) {
  ...
  const gruposFiltrados = useMemo(() => {
    ...
    return GRUPOS
      .map((grupo) => {
        // Si el residente escribe el nombre del grupo ("aseo"), se muestra entero.
  ...
  return (
    <>
      ...
      {abierto && (
        <div
          // Velo oscuro + desenfoque: el residente elige esto de pie en la calle,
