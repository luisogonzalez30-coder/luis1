...
// Política de privacidad pública (/:condominioSlug/privacidad), sin login.
//
// El contenido describe EXACTAMENTE lo que la app guarda hoy — se escribió
// leyendo `crearSolicitud` (solicitudesService.js) y `registrarTicketPublico`
      ...
      {(condominio) => (
        <>
          ...
          <Seccion titulo="Quién responde por tus datos">
            <p>
              La <strong>{condominio.nombre}</strong> es la responsable del tratamiento de tus datos
          ...
          <Seccion titulo="Qué datos recogemos">
            ...
            <ul className="list-disc space-y-1 pl-5">
              <li><strong>Tu nombre</strong> y <strong>tu número de WhatsApp</strong>, que son obligatorios: sin ellos el condominio no puede coordinar la visita ni avisarte cuando el trabajo esté hecho.</li>
          ...
          <Seccion titulo="Para qué los usamos">
            <ul className="list-disc space-y-1 pl-5">
              <li>Asignar tu reporte a la dirección del condominio que corresponde y a un equipo.</li>
              ...
              <li>Detectar que varios residentes están reportando el mismo problema, para atenderlo como uno solo.</li>
              <li>Producir estadísticas de gestión del condominio. Estas estadísticas son <strong>agregadas</strong>: cuentan reportes, tiempos y categorías, nunca personas identificadas.</li>
            </ul>
            <p>
          ...
          <Seccion titulo="Qué es público y qué no">
            <p>
              ...
              donde cualquiera puede ver los reportes de el condominio, y una página de transparencia
              con estadísticas.
            </p>
            ...
            <p className="rounded-xl bg-amber-50 p-3">
              ...
              hayas escrito en "detalles adicionales". Eso solo lo ven los usuarios
              del condominio autorizados.
            </p>
            <p>
              ...
              ubicación también es pública, así que no escribas ahí datos tuyos ni de tus residentes
              — describe el lugar, no a la gente.
            </p>
            <p>
              Dentro del condominio tampoco todos ven lo mismo: el equipo que va a terreno ve el
          ...
          <Seccion titulo="Con quién se comparten">
            ...
            <ul className="list-disc space-y-1 pl-5">
              ...
              <li><strong>WhatsApp (Meta)</strong>: transporta los mensajes que el condominio te envía. Aplican además sus propias condiciones, que aceptaste al instalar WhatsApp.</li>
            </ul>
            <p>
              Estos proveedores almacenan información en servidores fuera de Chile. La
              condominio puede informarte la región exacta de almacenamiento si lo solicitas.
            </p>
            <p>
          ...
          <Seccion titulo="Por cuánto tiempo los guardamos">
            <ul className="list-disc space-y-1 pl-5">
              <li><strong>Tu nombre y tu WhatsApp</strong>: mientras tu reporte esté abierto y hasta 2 años después de cerrado, plazo en que el condominio puede necesitar acreditar la gestión realizada.</li>
              <li><strong>El reporte sin tus datos de contacto</strong> (categoría, ubicación, fotos, fechas): se conserva de forma indefinida como registro de gestión del condominio y para las estadísticas históricas de el condominio.</li>
          ...
          <Seccion titulo="Tus derechos">
            ...
            <p>
              Para ejercerlos, escribe a <ContactoDatos condominio={condominio} />. El condominio
            ...
            <p className="text-xs text-gray-500">
              ...
              oposición. El condominio aplica desde ya el estándar más exigente de las dos.
            </p>
          </Seccion>

          <Seccion titulo="Si eres menor de edad">
            <p>
              Cualquier residente puede reportar un problema en la vía pública, sin importar su edad.
          ...
          <Seccion titulo="Cómo protegemos tus datos">
            <ul className="list-disc space-y-1 pl-5">
              ...
              <li>Cada usuario del condominio entra con su propia cuenta y ve solamente lo que su cargo requiere. Ese límite está aplicado en el servidor, no solo en la pantalla.</li>
              <li>La información del condominio se respalda automáticamente todos los días.</li>
              <li>Si llegara a ocurrir una filtración que afecte tus datos, el condominio debe notificarlo a la autoridad y, cuando corresponda, a ti.</li>
            </ul>
            <p>
          ...
          <Seccion titulo="Contacto">
            <p>
              ...
              arriba, escribe a <ContactoDatos condominio={condominio} />.
            </p>
          </Seccion>
        </>
     )}
