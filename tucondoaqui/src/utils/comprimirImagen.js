// Compresión de fotos en el celular del residente, ANTES de subirlas.
//
...
// menos puede pagarlos — los datos móviles del residente en zona rural, y la cuota
// del plan gratis de Cloudinary del condominio. Comprimir antes ataca los dos a
...
// Ajustables. 800 px y 500 kB son suficientes para que el equipo dimensione
// un bache o un basural. Si el condominio necesitara leer patentes o carteles en
...
export async function comprimirImagen(archivo) {
  ...
  try {
    ...
    // habría cobrado a TODOS los residentes que abren la app —incluidos los que
    ...
    // no un requisito: si falla, se sube el original y el residente ni se entera.
